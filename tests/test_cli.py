...
def test_fatf_command_exposes_refresh_surface() -> None:
    result = runner.invoke(
        app,
        [
            "fatf",
...
def test_fatf_refresh_orchestrates_trusted_evidence_pipeline(
    ...
    def fake_build_fatf_evidence(
        ...
        return FatfEvidenceResult(
            ...
            csv_path=(evidence_output_dir / FATF_CSV_FILENAME),
            json_path=(evidence_output_dir / FATF_JSON_FILENAME),
    ...
    manifest_snapshot, manifest_destination = captured_manifests[0]
    ...
    workflow_snapshot, workflow_output_dir = captured_workflows[0]
